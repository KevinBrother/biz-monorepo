...
const defaultFeatures: Feature[] = [
  ...
  },
  {
    ...
    content:
      'All components come with complete TypeScript definitions for better developer experience.',
  },
  {
    title: 'Customizable',
    description: 'Easy to customize and extend',
    content:
      'Components accept props for customization and can be easily extended or modified.',
  },
]
